			...
			function (require, module, exports) {
				...
				(ConvexHullGrahamScan.prototype = {
					...
					_findPolarAngle: function (n, t) {
						...
						return (
							this.reverse ? 0 >= r && (r += 360) : r >= 0 && (r += 360), r
						);
					},
				...
				(function (MakerJs) {
					...
					(function (model) {
						...
						function simplify(modelToSimplify, options) {
							...
							similarCircles.getCollectionsOfMultiple(function (
								key,
								circleRefs
							) {
				...
				(function (MakerJs) {
					...
					(function (measure) {
						...
						function getAngledBounds(
							...
							[result.top, result.middle, result.bottom].forEach(function (
								line
							) {
...
/**
 * My not-really-understanding-things way of
 * making this library available in the global scope
 * so I can stop wrestling with require and import
 */
